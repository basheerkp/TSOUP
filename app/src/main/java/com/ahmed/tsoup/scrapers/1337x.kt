            ...
            try {
                ...
                for (item: Element in listItems) {
                    when (item.select("strong").text()) {
                        ...
                        "Seeders" -> currentItem.seeds = item.select("span").text()
                        "Leechers" -> currentItem.leeches = item.select("span").text()

                        "Uploaded By" -> currentItem.uploader = item.select("span").text()
